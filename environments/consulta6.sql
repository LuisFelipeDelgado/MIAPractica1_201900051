...
finales AS (SELECT ciudades.PAIS, totales.total::integer as ciudades, ciudades.ciudad, ciudades.count as clientes, trunc(((ciudades.count::decimal*100)/totales.total),2)::float AS PORCENTAJE
